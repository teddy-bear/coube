		...
		<?php if ( $the_query->have_posts() ) { ?>
            <div class="house-plans-blocks row">
				<?php while ( $the_query->have_posts() ) {
					...
					//$category = wp_get_post_terms( $the_query->post->ID, 'model_homes_category' );
					// Get all taxonomies attached to the post.
					$terms      = get_the_terms( get_the_ID(), 'model_homes_category' );
					$term_names = array();
					if ( $terms ) {
