...
add_action( 'woocommerce_after_shop_loop_item_title', 'show_product_read_more_link', 9.5 );
		...
		while ( have_posts() ) {
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-md-pull-10 sidebar sidebar-shop">
					<?php //woocommerce_subcats_from_parentcat_by_NAME( 'flooring' ); ?>
...
/**
 * This code shows product atributs value
